...
**Note**: It is recommended to edit and save the settings the first time you use ElastiCache Navigator, even if you do not change anything. As this initializes the connections.
...
For recording historical metrics, ElastiCache Navigator uses am InfluxDB V2.x time series database. This can be :
...
Please refer to InfluxDB documentation for how to create the Token and bucket. ElastiCache Navigator will work also without InfluxDB, but then you will not have historical data in the monitoring page.