    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Note: ElastiCache Navigator can be extended to use your preferred login and user management hooks. Implementation depends on your specific environment (e.g.: SSO, Cognito, other). Please extend the function ManageUserLogin and ManageUserLogout for your needs.
          </DialogDescription>
        </DialogHeader>
