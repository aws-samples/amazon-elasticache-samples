...
2) Render ECS task definition
   export AWS_REGION=us-east-1
   export AWS_ACCOUNT_ID=111122223333
   export ECS_TASK_FAMILY=valkey-navigator
   export ECS_EXECUTION_ROLE=ecsTaskExecutionRole
   export ECS_TASK_ROLE=ecsTaskRole
   export BACKEND_IMAGE_URI=111122223333.dkr.ecr.us-east-1.amazonaws.com/valkey-navigator/valkey-navigator-backend:latest
   export FRONTEND_IMAGE_URI=111122223333.dkr.ecr.us-east-1.amazonaws.com/valkey-navigator/valkey-navigator-frontend:latest
   ...
   export INFLUXDB_BUCKET=valkey-navigator
   ...
   export AWS_KEY_SSM_PARAM_ARN=arn:aws:ssm:us-east-1:111122223333:parameter/valkey-navigator/aws_key
   export AWS_SECRET_ACCESS_KEY_SSM_PARAM_ARN=arn:aws:ssm:us-east-1:111122223333:parameter/valkey-navigator/aws_secret
...
3) Deploy/Update ECS service
   export CLUSTER_NAME=valkey-navigator-cluster
   export SERVICE_NAME=valkey-navigator
